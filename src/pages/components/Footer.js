                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="link-wrap">
                                    ...
                                    <ul>
                                        ...
                                        <li><Link href="/International Shipping">International Shipping</Link></li>
                                        <li><Link href="/Payment Options">Payment Options</Link></li>
                                        <li><Link href="/Track your Order">Track your Order</Link></li>
 ...
 */}
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="link-wrap">
                                    <h5>Contact Us</h5>
                                    <ul>
                                        <li className="d-flex align-items-center"><i className="bi bi-envelope" /><a href="mailto:info@sangamasilks.com">info@sangamasilks.com</a></li>
                                        <li className="d-flex align-items-center"><i className="bi bi-telephone" /><a href="tel:9876543210">9876543210</a></li>
